...
describe("home background depth styles", () => {
  ...
  it("balances desktop depth transforms and image fallbacks", () => {
    ...
    expect(layer).toMatch(/background-image:\s*url\("\/images\/backgrounds\/home-ink-landscape\.png"\);[\s\S]*background-image:\s*image-set\(url\("\/images\/backgrounds\/home-ink-landscape\.webp"\)/);
