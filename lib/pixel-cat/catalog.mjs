...
export const ACTIONS = ACTION_GROUPS.flatMap(([group, entries]) => entries.map(([id, label]) => ({ id, label, group, cycle: CYCLES[id], loop: !ONCE.has(id), duration: CYCLES[id] * (id === "sleep" || SCENE_IDS.includes(id) ? 2 : 1) })));
