  ...
  return (
    <section className="admin-page">
      ...
      <div className="admin-page__panel admin-page__panel--stacked">
        <form action={createCategoryAction} className="admin-post-form admin-card admin-form">
          <label>
            <span>Name</span>
          ...
          <button type="submit" className="admin-primary-button">Save category</button>
        </form>
